 ...
 *
 * ,-----------------------------------------.           ,-----------------------------------------.
 * |  Tab |   Q  |   W  |   F  |   P  |   B  |           |   J  |   L  |   U  |   Y  |:; MOD|   (  |
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | Shft |   A  |   R  |   S  |   T  |   G  |           |   M  |   N  |   E  |   I  |   O  |   '  |
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | Esc  |   Z  |   X  |   C  |   D  |   V  |           |   K  |   H  |   ,  |   .  |   /  | Win  |
 * `--------------------+--------------------'           `-----------------------------------------'
 *        ,------.         ,--------------------.    ,--------------------.          ,------.
 *        |QWERTY|         | LOWER| Enter| Ctrl |    |BckSpc| Space| RAISE|          | MUTE |
 *        `------'         `--------------------'    `--------------------.          `------'
 *                         ,--------------------.    ,--------------------.
 *                         | Undo | Redo2| Redo |    | Vol- | Mute | Vol+ |    // 3 way thumb switch
 *                         `--------------------'    `--------------------.
...
// Default config uses home row mods. So hold each of the keys on the home row to use ctrl, gui, alt, or shift
[_COLEMAK] = LAYOUT_ximi(
  KC_TAB,       KC_Q,        KC_W,          KC_F,         KC_P,         KC_B,         KC_J,    KC_L,         KC_U,         KC_Y,         COLONSWAP,    KC_LPRN,
  KC_LSFT,      KC_A,        KC_R,          KC_S,         KC_T,         KC_G,         KC_M,    KC_N,         KC_E,         KC_I,         KC_O,         KC_QUOT,
  KC_ESC,       KC_Z,        KC_X,          KC_C,         KC_D,         KC_V,         KC_K,    KC_H,         KC_COMM,      KC_DOT,       KC_SLSH,      KC_LGUI,
                TO(_QWERTY),                LOWER,        KC_ENT,       KC_LCTL,      KC_BSPC, KC_SPC,       RAISE,                      KC_MUTE,
                                            C(KC_Z),      C(S(KC_Z)),   C(KC_Y),      KC_VOLD, KC_MUTE,      KC_VOLU
),
 ...
 *
 * ,-----------------------------------------.           ,-----------------------------------------.
 * |AltTab|   1  |   2  |   3  |   4  |   5  |           |   6  |   7  |   8  |   9  |   0  | ____ |
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | Home | Left | Down |  Up  | Right| End  |           |      |   -  |   =  |   [  |   ]  | Right|
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | ____ |  Ctrl|   `  |  GUI |  Alt |      |           |      |      |      |   \  |   '  | ____ |
 * `-----------------------------------------'           `-----------------------------------------'
 *        ,------.         ,--------------------.    ,--------------------.          ,------.
 *        | MUTE |         | LOWER| Enter|      |    |BckSpc| Shft | RAISE|          | MUTE |
 *        `------'         `--------------------'    `--------------------.          `------'
 *                         ,--------------------.    ,--------------------.
 *                         | Undo | Redo2| Redo |    | Vol- | Mute | Vol+ |    // 3 way thumb switch
 *                         `--------------------'    `--------------------.
...
[_RAISE] = LAYOUT_ximi(
  ...
  KC_HOME,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,       _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_RGHT,
  _______,      KC_LCTL, KC_GRV,  KC_LGUI, KC_LALT, _______,      _______, _______, _______, KC_BSLS, KC_QUOT, _______,
                _______,          _______, KC_ENT , _______,      KC_BSPC, KC_LSFT, _______,          _______,
 ...
 * | ____ |   !  |   @  |   #  |   $  |   %  |           |   ^  |   &  |   *  |   (  |   )  | ____ |
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | ____ |  Esc | Copy |MouseR|MouseL|Paste |           |      |   _  |   +  |   {  |   }  | Right|
 * |------+------+------+------+------+------|           |------+------+------+------+------+------|
 * | ____ |  Caps|  Cut | EECLR|Reset |Btldr |           |      |      |      |   |  |   '  | ____ |
 * `-----------------------------------------'           `-----------------------------------------'
 *        ,------.         ,--------------------.    ,--------------------.          ,------.
...
[_LOWER] = LAYOUT_ximi(
  ...
  _______,      KC_ESC, LCTL(KC_C), KC_BTN2, KC_BTN1, LCTL(KC_V),   _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_RGHT,
  _______,      KC_CAPS,LCTL(KC_X), EE_CLR , QK_RBT,  QK_BOOT,      _______, _______, _______, KC_PIPE,  KC_DQT, _______,
